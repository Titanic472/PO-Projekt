...
@functools.total_ordering # total_ordering allows comparison decorators
class Entity:
    ...
    def __lt__(self, other):
        # Python heapq uses min-heap. So we want largest element to pop first. Thus we define `__lt__` such that larger element is "less".
